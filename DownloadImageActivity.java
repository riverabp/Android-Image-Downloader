...
public class DownloadImageActivity 
    ...
    private class DownloadRunnable implements Runnable {
        ...
        public void run() {
            final Uri diskUri = DownloadUtils.downloadImage(getApplicationContext(), getIntent().getData());
            Intent downloadImageIntent = new Intent();
            downloadImageIntent.setData(diskUri);
            setResult(MainActivity.RESULT_OK, downloadImageIntent);
